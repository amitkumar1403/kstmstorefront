                      ...
                      >
                        ...
                        {item.text == 'My Profile' ? (
                          ...
                          <div
                             ...
                             className={`ring-white relative ring-opacity-60 border-b border-slate-300 sm:border-0 cursor-pointer ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2  w-full  text-14  leading-5 text-left pl-4 ${item.text == "My Profile" ? "bg-white border-r-0  sm:border-b-0 sm:border-r-2 sm:border-black sm:font-bold sm:opacity-full" : "text-primary font-medium opacity-60"}`}
                  >
                             <span className="pr-2 leading-none align-middle acc-mob-icon-i sm:absolute top-2/4 -translate-y-2/4" >
                             ...
                             >
                                <a onClick={() => {
                                   ...
                                   className="inline-block w-full h-full text-sm lg:pl-14 md:pl-10 sm:pl-8 text-primary px-5 py-5">
