    ...
    <section className="relative pb-10 text-gray-900">
      <div className="w-full px-0 mx-auto accunt-main-container sm:px-0 lg:px-0">
        <div className="grid w-full grid-cols-12 px-4 pt-16 sm:px-2 sm:pr-0 main-account-grid">
          <div className="col-span-12 pl-16 border-r border-gray-200 lg:col-span-4 md:col-span-4 sm:pl-6 tab-list-sm sm:pt-10">
                        ...
                        >
                          ...
                          >
                            <a onClick={() => {
                              ...
                              className="inline-block w-full h-full px-5 py-5 text-sm sm:pl-8 text-primary">
          ...
          <div
            className={`relative col-span-12 lg:col-span-8 md:col-span-8 border-l tabpanel-sm mob-tab-full ${isShow ? `mob-hidden` : ''
              }`}
          >
