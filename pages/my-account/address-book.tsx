  ...
  return (
    ...
    <div className="w-full px-0 mx-auto accunt-main-container sm:px-0 lg:px-0">
      <div className="grid w-full grid-cols-12 px-4 sm:px-2 sm:pr-0 main-account-grid pt-16">
        <div className="col-span-3  pl-16 border-r border-gray-200 sm:pl-6 tab-list-sm sm:pt-10 mob-hidden">
              ...
              <div
                className={`relative col-span-12 lg:col-span-8 md:col-span-8 border-l tabpanel-sm mob-tab-full ${
                  isShow ? `mob-hidden` : ''
                }`}
              >
