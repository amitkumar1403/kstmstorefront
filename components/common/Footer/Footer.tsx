  ...
  return (
    <footer aria-labelledby="footer-heading" className="bg-black p-2 mt-5">
      ...
      <div className="grid grid-cols-2 gap-0 py-3 mt-4">
        <h1 className="text-white lg:text-xl md:text-lg sm:text-md font-bold xl:text-2xl mt-4 ml-20 uppercase">
          {QUERY}
          {/* {SIGN_UP_TEXT} */}
        </h1>
      ...
      <div className="mx-auto w-full sm:w-4/5 px-4 sm:px-0 lg:px-0">
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 gap-0 xl-gap-8 lg-gap-8">
          {/* Image section */}
            ...
            <div className="w-full newsletter-form">
              ...
              <div className="flex justify-between">
                <input
                  ...
                  required
                  placeholder="Email"
                  className="h-12 form-control block w-2/3 px-3 py-1.5 text-md font-bold text-start text-white bg-black border border-solid border-gray-300 transition ease-in-out m-0
              ...
              <div className="w-full">
                <button
                  type="submit"
                  className="w-full  bg-black border border-white rounded-sm py-3 uppercase px-6 flex items-center justify-center font-bold text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
                >
                  {BTN_SUBSCRIBE}
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 gap-0 text-center lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 lg:text-left pt-4 pb-8">
            ...
            <div className="pt-4">
              <strong className="lg:px-6 md:px-4 sm:px-2 text-white lg:text-2xl md:text-lg sm:text-xs xs:text-xs">
                CUSTOMER
              </strong>
              <nav
      ...
      <div className="border-t border-gray-100 pt-2 pb-2 text-center">
        <div className="grid grid-cols-3 gap-0 mr-14">
          <div className="mx-14">
            {' '}
            <p className="text-2xl sm:text-md md:text-xl lg:text-2xl xl:text-2xl font-bold mt-0 font-heading mx-14 mx-auto text-white">
          ...
          <div className="flex justify-end">
            <a
              className="text-white transition hover:text-gray-700/75 xl:mx-2 lg:mx-2 md:mx-2 sm:mx-1"
              href=""
              target="_blank"
              rel="noreferrer"
            >
